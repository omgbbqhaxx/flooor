          ...
          theme={
            ...
            lightMode: {
              colors: {
                ...
                downloadBottomCardBackground: 'linear-gradient(126deg, rgba(209, 213, 218, 0) 9.49%, rgba(171, 171, 171, 0.04) 71.04%), #d1d5da',
                downloadTopCardBackground: 'linear-gradient(126deg, rgba(171, 171, 171, 0.2) 9.49%, rgba(209, 213, 218, 0) 71.04%), #d1d5da',
                error: '#FF494A',
