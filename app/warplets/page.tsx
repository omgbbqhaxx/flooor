...
export default function WarpletsPage() {
  ...
  useEffect(() => {
    document.title = "Warplets · flooor.fun — 5% royalty accumulates in the daily vault — 16-hour sign phase, 8-hour claim phase";
  }, []);
  ...
  return (
    ...
    >
      {/* Header */}
      <SiteHeader collectionUrl="https://opensea.io/collection/vrnouns" soundOn={soundOn} onToggleSound={toggleSound} />
