...
export default function BaseDayOnePage() {
  ...
  useEffect(() => {
    document.title = "Base Day One · Flooor";
  }, []);
      ...
      <main className="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        {IS_DEPLOYED && (
          <div className="mt-20 w-full" style={{ maxWidth: "900px" }}>
            <p style={smallCaps}>Your Base Day One</p>
            {!address ? (
                ...
                <p style={{ ...SANS, fontSize: "14px", color: MUTED, marginTop: "16px" }}>
                  No Base Day One found in this wallet.
                </p>
              ) : (
