...
import LOOPERS_ABI from "@/app/abi/loopers.json";
...
const CONTRACT_ADDR = "0xD3706917c71b1A81CeCc31311C6B41eac344DDb5" as const;
const COLLECTION_ADDR = "0x1649CD37f4748807b4882FC48765bA0B2aFfa94a" as const;
...
const LOOPERS_IMG =
  "https://i2c.seadn.io/collection/loopers-639312714/image_type_section_media/b5d3e9fbc1c2a0e09e40d824d2a9f5/37b5d3e9fbc1c2a0e09e40d824d2a9f5.png";
...
const resolveUri = (uri: string): string => {
  ...
  // Loopers metadata Arweave'de: tokenURI https, image alanı "ar://<txid>"
...
export default function LoopersPage() {
  const config = useConfig();

  useEffect(() => {
    document.title = "Loopers · flooor.fun — 5% royalty accumulates in the daily vault — 16-hour sign phase, 8-hour claim phase";
  }, []);
  ...
  // Loopers koleksiyonu ERC721Enumerable değil (tokenOfOwnerByIndex yok —
  ...
  const handleBid = useCallback(async () => {
    if (isBidding) return;
    if (!IS_DEPLOYED) {
      toast.info("Loopers contract is not live yet — stay tuned.");
      return;
    }
    if (!address) {
  ...
  const handleShare = useCallback(
    async (platform: "x" | "farcaster") => {
      ...
      // (Loopers'a özel bir handle belirtilmedi — bkz. social-share-mentions memory)
      const mentions =
        platform === "farcaster"
          ? "@farcaster /flooor"
          : "@vrnouns @base @CoinbaseWallet";
      const text = `${sharePrompt.text}\n\n${mentions}`;
      const url = "https://flooor.fun/loopers";
      setSharePrompt(null);
  ...
  return (
    ...
    >
      {/* Header */}
      <SiteHeader collectionUrl="https://opensea.io/collection/loopers-639312714" soundOn={soundOn} onToggleSound={toggleSound} />
            ...
            <div className="flex items-center justify-center">
              ...
              >
                ...
                <div className="px-3.5 py-3 flex flex-wrap items-center justify-between gap-x-4 gap-y-1.5">
                  ...
                  <a
                    href="https://opensea.io/collection/loopers-639312714"
                    target="_blank"
            ...
            {!IS_DEPLOYED ? (
              ...
              >
                ...
                <p style={{ ...SANS, fontSize: "14px", color: MUTED, lineHeight: 1.6 }}>
                  The Loopers contract is being finalized and isn&apos;t live yet. Connect your wallet to be ready when it ships.
                </p>
              </div>
            ) : (
              <div>
